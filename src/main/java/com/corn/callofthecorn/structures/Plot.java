...
//
//public class Plot extends StructureFeature<NoneFeatureConfiguration> {
//    public Plot(Codec<NoneFeatureConfiguration> codec) {
//        super(codec);
//    }
//
//    /**
...
//                            .get(new ResourceLocation(Main.MODID, "plot")),
//
