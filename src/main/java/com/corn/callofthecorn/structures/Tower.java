...
//
//public class Tower extends StructureFeature<NoneFeatureConfiguration> {
//    public Tower(Codec<NoneFeatureConfiguration> codec) {
//        super(codec);
//    }
//
//    @Override
...
//
//                            .get(new ResourceLocation(Main.MODID, "tower")),
//
