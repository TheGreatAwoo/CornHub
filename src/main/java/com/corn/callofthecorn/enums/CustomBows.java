...
public class CustomBows extends BowItem {
...
//    int Drawtime;
    ...
    public CustomBows(Properties p_40660_ , int Range , int Damage , int Drawtime,boolean Fire) {
        super(p_40660_);
        this.Damage=Damage;
        this.Range=Range;
        this.Fire=Fire;
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!p_40668_.isClientSide) {
                        ...
                        p_40667_.hurtAndBreak(10, player, (p_40665_) -> {
