...
public class CustomStaffs extends BowItem {
    ...
    public CustomStaffs(Properties p_40660_, int explosionPower,boolean boss) {
        super(p_40660_);
...
//    }
    ...
    public Predicate<ItemStack> getAllSupportedProjectiles() {
        return  ((p_43015_) -> {
            ...
            if(boss==false){
                Itemused=ItemInit.LESSERSOUL.get();
            return p_43015_.is(ItemInit.CORNSOUL.get());
                }
            Itemused=ItemInit.LESSERSOUL.get();
            return p_43015_.is(ItemInit.LESSERSOUL.get());
