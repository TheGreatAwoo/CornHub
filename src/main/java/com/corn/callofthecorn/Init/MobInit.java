...
import com.corn.callofthecorn.entities.CropWatcher.CropWatcher;
import com.corn.callofthecorn.entities.Crow.Crow;
import com.corn.callofthecorn.entities.FarmHand.Farmhand;
import com.corn.callofthecorn.entities.HarvestCrow.Harvest;
...
public class MobInit {
    ...
    public static final RegistryObject<EntityType<Harvest>> HARVEST = ENTITY_TYPES.register("harvest",
            () -> EntityType.Builder.<Harvest>of(Harvest::new, MobCategory.MONSTER)
...
//                    .fireImmune()
    ...
    public static void registerAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(HARVEST.get(), Mob.createMobAttributes()
                ...
                .add(Attributes.MAX_HEALTH, Harvest.MAX_HP)
                .add(Attributes.KNOCKBACK_RESISTANCE, .9)
                .add(Attributes.ATTACK_DAMAGE,Harvest.AttackDamage)
                .add(Attributes.ATTACK_SPEED,1)
