...
public class ItemInit {
	...
	public static final RegistryObject<Item> PUMPKINGSCROWN = ITEMS.register("pumpkingscrown",() -> new PumpCrown(CustomMaterials.Pumpkin, EquipmentSlot.HEAD, defaultitemproperties()));
	...
	public static final RegistryObject<Item> CORNMETALPANTS = ITEMS.register("cornmetalpants",() -> new Cornmetal(CustomMaterials.cornmetal, EquipmentSlot.LEGS,defaultitemproperties()));
	public static final RegistryObject<Item> CORNMETALHEAD = ITEMS.register("cornmetalhead",() -> new Cornmetal(CustomMaterials.cornmetal, EquipmentSlot.HEAD, defaultitemproperties()));
	public static final RegistryObject<Item> CORNMETALFEET = ITEMS.register("cornmetalfeet",() -> new Cornmetal(CustomMaterials.cornmetal, EquipmentSlot.FEET, defaultitemproperties()));
	public static final RegistryObject<Item> CORNMETALCHEST = ITEMS.register("cornmetalchest",() -> new Cornmetal(CustomMaterials.cornmetal, EquipmentSlot.CHEST,defaultitemproperties()));
	...
	public static final RegistryObject<Item> MAIZERITEPANTS = ITEMS.register("maizeritepants",() -> new Mazierite(CustomMaterials.mazierite, EquipmentSlot.LEGS,defaultitemproperties()));
	public static final RegistryObject<Item> MAIZERITEHEAD = ITEMS.register("maizeritehead",() -> new Mazierite(CustomMaterials.mazierite, EquipmentSlot.HEAD, defaultitemproperties()));
	public static final RegistryObject<Item> MAIZERITEFEET = ITEMS.register("maizeritefeet",() -> new Mazierite(CustomMaterials.mazierite, EquipmentSlot.FEET, defaultitemproperties()));
	public static final RegistryObject<Item> MAIZERITECHEST = ITEMS.register("maizeritechest",() -> new Mazierite(CustomMaterials.mazierite, EquipmentSlot.CHEST,defaultitemproperties()));
	...
	private static Item.Properties defaultitemproperties(){
		return new Item.Properties().tab(CornTab.TAB_Corn);
	}
